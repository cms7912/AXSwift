...
open class UIElement {
  ...
  public lazy var id: String = {
    if let myID: String? = try? self.attribute(.identifier),
    let myID {
      return myID
    }
  ...
  public lazy var children: [UIElement] = {
    if let myChildren: [AXUIElement]? = try? self.attribute(.children),
    let myChildren {
      return myChildren.map{UIElement($0)}
    }
    return []
  }()

  public lazy var title: String = {
    if let myTitle: String? = try? self.attribute(.title),
    let myTitle {
      return myTitle
    }
    return "-"
  ...
  public lazy var roleString: String = {
    if let myRole: String? = try? self.attribute(.role),
    let myRole {
      return myRole
    }
    return "(role)"
  ...
  public lazy var subroleString: String = {
    if let mySubrole: String? = try? self.attribute(.subrole),
    let mySubrole {
      return mySubrole
    }
    return "(subrole)"
  ...
  public lazy var actionsList: String = {
    if let myActions: [String]? = try? self.actionsAsStrings(),
    let myActions {
      return myActions.joined(separator: ",")
    }
    return "(actions)"
  }()
